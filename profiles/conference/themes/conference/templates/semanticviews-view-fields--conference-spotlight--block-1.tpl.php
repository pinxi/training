...
?>
<?php  
  $url = $fields['field_spotlight_image_fid']->content;
  unset($fields['field_spotlight_image_fid']);
?>
<div class="spotlight-container" style="background: transparent url('<?php print $url ?>') no-repeat;"><div class="inner">
  <div class="sizer"></div>
